        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>
                        Here you can browse and buy instruments, Records and music related Accessories. Order now for your amazing New Kit!
                    </p>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>
                        Music brings joy, to all of our hearts, It's one of those emotional arts.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Instrument"/>" role="button">
                <img src="<c:url value="/resources/images/instrument.jpg"/>" alt="Instrument Image" width="140" height="140" class="img-circle">
            </a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Record"/>" role="button">
                <img src="<c:url value="/resources/images/record.jpg"/>" alt="Instrument Image" width="140" height="140" class="img-circle">
            </a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Accessory"/>" role="button">
                <img src="<c:url value="/resources/images/accessory.jpg"/>" alt="Record Image" width="140" height="140" class="img-circle">
            </a>
